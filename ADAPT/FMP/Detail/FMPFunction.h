...
FMP_DEFINE_FUNC3_WITH_BUFFER(vec3, Flt, Flt, Flt, Vec, CUF_TIE_ARGS(mBuffer->resize(3); *mBuffer << a, b, c; return *mBuffer;), CUF_TIE_ARGS(Eigen::VectorXd v(3); v << a, b, c; return v;), true, false)
